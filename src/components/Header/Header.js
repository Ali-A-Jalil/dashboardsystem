...
import { MdOutlineMenu, MdOutlineMenuOpen, MdOutlineLightMode } from "react-icons/md";
...
const Header = ({ toggleSidebar, isSidebarOpen, user, onLogout }) => {
    ...
    const openLanguage = Boolean(isOpenLanguage);
    ...
    const handleOpenLanguageMenu = (event) => {
        setIsOpenLanguage(event.currentTarget);
    };
            ...
            <div className="container-fluid w-100">
                <div className="row d-flex align-items-center">
                    ...
                    <div className="menuPartTwo col-sm-7 d-flex align-items-center justify-content-end ">
                        ...
                        <Button className='rounded-circle mr-3' onClick={handleOpenLanguageMenu}><GrLanguage /></Button>
                        <Menu
                            ...
                            >
                                <MenuItem onClick={handleCloseLanguageMenu}>Arabic</MenuItem>
                                <MenuItem onClick={handleCloseLanguageMenu}>English</MenuItem>
                            </Menu>
                        <Button className='rounded-circle mr-3' onClick={handleOpenMyAccDr}><IoCartOutline /></Button>
                        <Button className='rounded-circle mr-3' onClick={handleOpenMyAccDr}><HiOutlineMail /></Button>
